...
namespace apiproject.Models
{
    public static class ModelBuilderExtensions
    {
        ...
        public static void ArticleSeed(this ModelBuilder modelBuilder){
            modelBuilder.Entity<Category>().HasData(
                new Category { Id = 101, Name = "Software Development" },
                new Category { Id = 102, Name = "Mobile App Development" },
                new Category { Id = 103, Name = "Graphics Design" },
                new Category { Id = 104, Name = "Printing & Publish" },
                new Category { Id = 105, Name = "AI Development" }
            );

            modelBuilder.Entity<Post>().HasData(
                new Post { Id = 1, CategoryId=101, Title = "News related tiles", Content = "Reference site about Lorem Ipsum, giving information on its origins, as well as a random", IsPublished=false},
                new Post { Id = 2, CategoryId=102, Title = "Some News tiles here", Content = "Giving information on its origins, as well as a random", IsPublished=false},
                new Post { Id = 3, CategoryId=103, Title = "Amazing news related tiles", Content = "Lorem Ipsum, giving information on its origins, as well as a random", IsPublished=true},
                new Post { Id = 4, CategoryId=104, Title = "Technology related tiles", Content = "About Lorem Ipsum, giving information on its origins, as well as a random", IsPublished=false},
                new Post { Id = 5, CategoryId=105, Title = "Apps related tiles", Content = "information Reference site about Lorem Ipsum, giving information on its origins, as well as a random", IsPublished=true}
